...
JS::Value JSI_VFS::BuildDirEntList(ScriptInterface::RealmPrivate* pRealmPrivate, const std::vector<CStrW>& validPaths, const std::wstring& path, const std::wstring& filterStr, bool recurse)
{
	if (!PathRestrictionMet(pRealmPrivate, validPaths, path))
		return JS::NullValue();
...
bool JSI_VFS::FileExists(ScriptInterface::RealmPrivate* pRealmPrivate, const std::vector<CStrW>& validPaths, const CStrW& filename)
{
	return PathRestrictionMet(pRealmPrivate, validPaths, filename) && g_VFS->GetFileInfo(filename, 0) == INFO::OK;
}

// Return time [seconds since 1970] of the last modification to the specified file.
double JSI_VFS::GetFileMTime(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& filename)
{
	CFileInfo fileInfo;
...
unsigned int JSI_VFS::GetFileSize(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& filename)
{
	CFileInfo fileInfo;
	Status err = g_VFS->GetFileInfo(filename, &fileInfo);
	JS_CHECK_FILE_ERR(err);
...
JS::Value JSI_VFS::ReadJSONFile(ScriptInterface::RealmPrivate* pRealmPrivate, const std::vector<CStrW>& validPaths, const CStrW& filePath)
{
...
void JSI_VFS::WriteJSONFile(ScriptInterface::RealmPrivate* pRealmPrivate, const std::wstring& filePath, JS::HandleValue val1)
{
	...
	std::string str(pRealmPrivate->pScriptInterface->StringifyJSON(&val, false));
...
bool JSI_VFS::PathRestrictionMet(ScriptInterface::RealmPrivate* pRealmPrivate, const std::vector<CStrW>& validPaths, const CStrW& filePath)
{
...
JS::Value Script_ReadJSONFile_##context(ScriptInterface::RealmPrivate* pRealmPrivate, const std::wstring& filePath)\
{\
	return JSI_VFS::ReadJSONFile(pRealmPrivate, PathRestriction_##context, filePath);\
}\
JS::Value Script_ListDirectoryFiles_##context(ScriptInterface::RealmPrivate* pRealmPrivate, const std::wstring& path, const std::wstring& filterStr, bool recurse)\
{\
	return JSI_VFS::BuildDirEntList(pRealmPrivate, PathRestriction_##context, path, filterStr, recurse);\
}\
bool Script_FileExists_##context(ScriptInterface::RealmPrivate* pRealmPrivate, const std::wstring& filePath)\
{\
	return JSI_VFS::FileExists(pRealmPrivate, PathRestriction_##context, filePath);\
}\
